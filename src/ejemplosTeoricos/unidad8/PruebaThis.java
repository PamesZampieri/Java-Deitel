...
class TiempoSimple {
    ...
    public String crearString() {
        return String.format("%24s: %s%n%24s: %s", "this.aStringUniversal()", this.aStringUniversal(),
    ...
    public String aStringUniversal() {
        ...
        // ya que el método no tiene variables locales con los mismos nombres que las variables de instancia
