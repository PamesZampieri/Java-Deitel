...
// Programa de prueba de la interfaz PorPagar que procesa objetos Factura y Empleado mediante el polimorfismo.
...
public class PruebaInterfazPorPagar {
    public static void main(String[] args) {
        ...
        objetosPorPagar[2] = new EmpleadoAsalariado("John", "Smith", "111-11-1111",
                800.00);
        objetosPorPagar[3] = new EmpleadoAsalariado("Lisa", "Barnes", "888-88-8888",
                1200.00);
